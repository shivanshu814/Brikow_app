...
class _fourthState extends State<fourth> {
  ...
  void createBox() async {
    ...
    box1.put("name", widget.name);
    box1.put("location",widget.location);
  }
          ...
          Expanded(child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(widget.name.toUpperCase(),style:TextStyle(color: Colors.black54,fontSize: 18,fontWeight: FontWeight.w400))
                ],
              )),),
          Container(
            child: Column(
